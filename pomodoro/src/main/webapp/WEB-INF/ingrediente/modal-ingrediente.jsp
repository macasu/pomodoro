		...
		<div class="modal-content">
			<form id="form-ingrediente" method="post">
				<div class="modal-header">
					...
					<h4 class="modal-title">Informacion Ingrediente</h4>
				</div>
				<div class="modal-body">
					<label for="nombre">Nombre: </label> <input id="nombre"
						name="nombre" class="form-control"> <label for="categoria">Categoria:
				...
				<div class="modal-footer">
					...
					<button id="btn-guardar" type="button" class="btn btn-primary">Guardar Informacion</button>
				</div>
			</form>
		</div>
	</div>
